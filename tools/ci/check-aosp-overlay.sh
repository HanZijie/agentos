...
required=(
  ...
  "$overlay/system/agent/aidl/com/example/agentos/AgentHealth.aidl"
  "$overlay/system/agent/aidl/com/example/agentos/AgentPluginDescriptor.aidl"
  "$overlay/system/agent/aidl/com/example/agentos/IAgentPluginEndpoint.aidl"
  "$overlay/system/agent/aidl/com/example/agentos/IAgentManager.aidl"
  "$overlay/system/agent/aidl/com/example/agentos/ISideagentd.aidl"
